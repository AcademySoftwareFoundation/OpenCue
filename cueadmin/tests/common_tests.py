...
import cuebot.proto.service_pb2
    ...
    def testListShows(self, getShowsMock, getStubMock, findShowMock):
        ...
        getShowsMock.return_value = [
            opencue.wrappers.show.Show(
                cuebot.proto.show_pb2.Show(
                    name='testing',
                    active=True,
                    show_stats=cuebot.proto.show_pb2.ShowStats(
                        reserved_cores=265,
                        running_frames=100,
                        pending_frames=248,
                        pending_jobs=29
    ...
    def testListAllocs(self, getAllocsMock, getStubMock, findAllocMock):
        ...
        getAllocsMock.return_value = [
            opencue.wrappers.allocation.Allocation(
                cuebot.proto.facility_pb2.Allocation(
                    name='local.desktop',
                    tag='desktop',
                    billable=False,
                    stats=cuebot.proto.facility_pb2.AllocationStats(
                        running_cores=100,
                        available_cores=125,
                        cores=600,
                        locked_hosts=25,
...
class HostTests(unittest.TestCase):
    ...
    def testMoveHost(self, findAllocMock, getStubMock, hostSearchMock):
        ...
        host = opencue.wrappers.host.Host(cuebot.proto.host_pb2.Host())
...
class JobTests(unittest.TestCase):
    ...
    def testListJobs(self, getStubMock, jobSearchMock):
        ...
        jobSearchMock.byMatch.return_value = cuebot.proto.job_pb2.JobGetJobsResponse(
            jobs=cuebot.proto.job_pb2.JobSeq(
                jobs=[
                    cuebot.proto.job_pb2.Job(
                        name='d7HXvMXDNMKyfzLumwsY-P3CNG1w4pa452dGcqOyf_qVK5PbHmCZafkv4rEF8d',
                        is_paused=False,
                        group='u0uMmB1O0z3ZkvreFYzP',
                        job_stats=cuebot.proto.job_pb2.JobStats(
                            running_frames=5,
                            reserved_cores=5,
                            waiting_frames=182,
                        ),
...
class ProcTests(unittest.TestCase):
    ...
    def testListProcs(self, getStubMock, procSearchMock):
        ...
        procSearchMock.byOptions.return_value = \
            cuebot.proto.host_pb2.ProcGetProcsResponse(
                procs=cuebot.proto.host_pb2.ProcSeq(
                    procs=[
                        cuebot.proto.host_pb2.Proc(
                            name='proc1',
                            reserved_cores=28,
                            used_memory=44,
                            reserved_memory=120,
    ...
    def testListDefaultServices(self, getDefaultServicesMock, getStubMock):
        ...
        getDefaultServicesMock.return_value = [
            opencue.wrappers.service.Service(
                cuebot.proto.service_pb2.Service(
                    name='maya',
                    threadable=False,
                    min_cores=100,
                    min_memory=2097152,
