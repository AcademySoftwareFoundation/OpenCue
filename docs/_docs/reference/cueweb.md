...
| **Controls** | Per-pane page picker (top-level routes), **Swap** panes, **Reset 50/50**, and an open-in-new-tab link per pane. On phones (`max-width: 767px`) the panes stack vertically without a draggable divider. |
