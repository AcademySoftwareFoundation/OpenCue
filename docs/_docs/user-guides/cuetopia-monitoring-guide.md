...
| **Available Time** | Timestamp the frame became eligible to run (left DEPEND for WAITING). Defaults to the job's submission time when the frame was never blocked. Subtract from Start Time to see the wait-for-pickup duration. | MM/DD HH:MM |
