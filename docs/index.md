        ...
        <div class="walkthrough-layout">
            ...
            <div class="walkthrough-list">
                <div class="walkthrough-item">
                    <div class="walkthrough-item-icon">
                        <i class="fa-solid fa-cube" aria-hidden="true"></i>
                    </div>
                    <div class="walkthrough-item-text">
                        <h3>Submitting Jobs</h3>
                        <p>Launch the submission form, configure job details, and set job types and services for your render.</p>
                    </div>
                </div>
                <div class="walkthrough-item">
                    <div class="walkthrough-item-icon">
                    ...
                    <div class="walkthrough-item-text">
                        ...
                        <p>Configure relationships between render jobs to control execution order and manage complex workflows.</p>
                    </div>
                </div>
                <div class="walkthrough-item">
                    <div class="walkthrough-item-icon">
                    ...
                    <div class="walkthrough-item-text">
                        <h3>Job Hierarchy</h3>
                        <p>Learn how OpenCue organizes work into Jobs, Layers, and Frames for efficient render management.</p>
                    </div>
                </div>
                <div class="walkthrough-item">
                    <div class="walkthrough-item-icon">
...
<!-- Feature Cards Grid -->
<section class="features-section features-section--dark" aria-labelledby="features-heading">
    ...
    <div class="history-container">
        ...
        <div class="timeline">
            <div class="timeline-entry">
                ...
                <h3 class="timeline-title">Early Foundations</h3>
                <p class="timeline-description">Early internal tools and scripts supported the first large-scale rendering workflows at <a href="https://www.imageworks.com/" target="_blank" rel="noopener noreferrer">Sony Pictures Imageworks</a> (SPI).</p>
            </div>
            ...
            <div class="timeline-entry">
                ...
                <h3 class="timeline-title">ASWF Adoption</h3>
                <p class="timeline-description">OpenCue became an <a href="https://www.aswf.io/projects/" target="_blank" rel="noopener noreferrer">official Academy Software Foundation project</a>.</p>
            </div>

            <div class="timeline-entry">
                <span class="timeline-date">2023</span>
                <h3 class="timeline-title">Academy Award</h3>
                <p class="timeline-description">Matt Chambers received a Scientific and Technical Academy Award for pioneering <a href="https://www.imageworks.com/" target="_blank" rel="noopener noreferrer">Sony Pictures Imageworks</a>' original Cue3 system, later adapted as the Plow system at another company. Cue3 was further enhanced and evolved into what is now known as OpenCue.</p>
            </div>
