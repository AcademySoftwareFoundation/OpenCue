...
class FrameMonitorTreeTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.job = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(id='foo'))
    ...
    def test_tickInitialLoad(self, getFramesMock):
        frames = [
            opencue.wrappers.frame.Frame(
                cuebot.proto.job_pb2.Frame(name='frame1')),
            opencue.wrappers.frame.Frame(
                cuebot.proto.job_pb2.Frame(name='frame2'))]
    ...
    def test_tickUpdateChanged(self, getFramesMock, getUpdatedFramesMock):
        getFramesMock.return_value = []
        getUpdatedResponse = cuebot.proto.job_pb2.JobGetUpdatedFramesResponse(
            state=cuebot.proto.job_pb2.RUNNING,
            server_time=1000,
            updated_frames=cuebot.proto.job_pb2.UpdatedFrameSeq(
                updated_frames=[cuebot.proto.job_pb2.UpdatedFrame(id='foo')]))
    ...
    def test_getCores(self):
        frame = opencue.wrappers.frame.Frame(
            cuebot.proto.job_pb2.Frame(last_resource='foo/125.82723/0'))
...
class FrameWidgetItemTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.state = cuebot.proto.job_pb2.RUNNING
        ...
        self.frame = opencue.wrappers.frame.Frame(
            cuebot.proto.job_pb2.Frame(
                ...
                state=self.state,
                checkpoint_state=cuebot.proto.job_pb2.ENABLED))
        ...
        self.frameWidgetItem = cuegui.FrameMonitorTree.FrameWidgetItem(
            ...
            opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(id='unused-job-id')))
