...
class FilterDialogTests(unittest.TestCase):
    ...
    @mock.patch('PySide6.QtWidgets.QInputDialog.getText')
    ...
    def test_shouldCloseDialog(self):
        self.assertEqual(PySide6.QtWidgets.QDialog.DialogCode.Rejected, self.filterDialog.result())

        self.filterDialog._FilterDialog__btnDone.click()

        self.assertEqual(PySide6.QtWidgets.QDialog.DialogCode.Accepted, self.filterDialog.result())
...
class FilterMonitorTreeTests(unittest.TestCase):
    ...
    @mock.patch('PySide6.QtWidgets.QMenu')
    def test_shouldRaiseContextMenu(self, qMenuMock):
        ...
        self.filterMonitorTree.contextMenuEvent(
            PySide6.QtGui.QContextMenuEvent(
                PySide6.QtGui.QContextMenuEvent.Reason.Mouse,
...
class MatcherMonitorTreeTests(unittest.TestCase):
    ...
    @mock.patch(
        ...
        new=mock.Mock(return_value=PySide6.QtWidgets.QMessageBox.Yes))
    ...
    @mock.patch(
        'PySide6.QtWidgets.QMessageBox.question',
        new=mock.Mock(return_value=PySide6.QtWidgets.QMessageBox.No))
