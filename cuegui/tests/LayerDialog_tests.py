    ...
    def setUp(self, get_stub_mock, get_layer_mock, get_limits_mock):
        ...
        get_limits_mock.return_value = [
            opencue.wrappers.limit.Limit(
                cuebot.proto.limit_pb2.Limit(id='limit1Id', name='limit1Name')),
            opencue.wrappers.limit.Limit(
                cuebot.proto.limit_pb2.Limit(id='limit2Id', name='limit2Name')),
            opencue.wrappers.limit.Limit(
                cuebot.proto.limit_pb2.Limit(id='limit3Id', name='limit3Name')),
            opencue.wrappers.limit.Limit(
                cuebot.proto.limit_pb2.Limit(id='limit4Id', name='limit4Name')),
        ]
