...
class JobActionsTests(unittest.TestCase):
    ...
    @mock.patch('PySide6.QtWidgets.QInputDialog.getDouble')
    ...
    @mock.patch('PySide6.QtWidgets.QInputDialog.getInt')
    ...
    @mock.patch('PySide6.QtWidgets.QApplication.clipboard')
...
class SubscriptionActionsTests(unittest.TestCase):
    ...
    @mock.patch('PySide6.QtWidgets.QMessageBox')
    @mock.patch('PySide6.QtWidgets.QInputDialog.getDouble')
    def test_editSize(self, getDoubleMock, qMessageBoxMock):
        ...
        qMessageBoxMock.return_value.exec_.return_value = PySide6.QtWidgets.QMessageBox.Yes
