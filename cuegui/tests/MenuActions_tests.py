...
import cuebot.proto.facility_pb2
import cuebot.proto.filter_pb2
import cuebot.proto.host_pb2
import cuebot.proto.job_pb2
import cuebot.proto.limit_pb2
import cuebot.proto.subscription_pb2
import cuebot.proto.task_pb2
...
class JobActionsTests(unittest.TestCase):
    ...
    def test_view(self):
        ...
        job = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(name=job_name))
    ...
    def test_setMinCores(self, getDoubleMock):
        ...
        job1 = opencue.wrappers.job.Job(
            cuebot.proto.job_pb2.Job(min_cores=highest_current_core_count - 10))
        job1.setMinCores = mock.Mock()
        job2 = opencue.wrappers.job.Job(
            cuebot.proto.job_pb2.Job(min_cores=highest_current_core_count))
    ...
    def test_setMinCoresCanceled(self, getDoubleMock):
        job1 = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(min_cores=0))
        job1.setMinCores = mock.Mock()
        job2 = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(min_cores=0))
        job2.setMinCores = mock.Mock()
    ...
    def test_setMaxCores(self, getDoubleMock):
        ...
        new_core_count = 50
        job1 = opencue.wrappers.job.Job(
            cuebot.proto.job_pb2.Job(max_cores=highest_current_core_count - 10))
        job1.setMaxCores = mock.Mock()
        job2 = opencue.wrappers.job.Job(
            cuebot.proto.job_pb2.Job(max_cores=highest_current_core_count))
    ...
    def test_setMaxCoresCanceled(self, getDoubleMock):
        job1 = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(max_cores=0))
        job1.setMaxCores = mock.Mock()
        job2 = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(max_cores=0))
        job2.setMaxCores = mock.Mock()
        getDoubleMock.return_value = (None, False)
    ...
    def test_setPriority(self, getIntMock):
        job = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(priority=0))
    ...
    def test_kill(self, isPermissibleMock, yesNoMock):
        job = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(name='job-name'))
        job.kill = mock.Mock()
    ...
    def test_eatDead(self, isPermissibleMock, yesNoMock):
        ...
        job.eatFrames.assert_called_with(state=[cuebot.proto.job_pb2.DEAD])
    ...
    def test_retryDead(self, isPermissibleMock, yesNoMock):
        ...
        job.retryFrames.assert_called_with(state=[cuebot.proto.job_pb2.DEAD])
    ...
    def test_reorder(self, getTextMock, getItemMock):
        ...
        job.getLayers = lambda: [
            opencue.wrappers.layer.Layer(
                cuebot.proto.job_pb2.Layer(range=original_range))]
        ...
        job.reorderFrames.assert_called_with(original_range, cuebot.proto.job_pb2.REVERSE)
    ...
    def test_sendToGroup(self, findShowMock, move_itemsMock):
        ...
        group = opencue.wrappers.group.Group(cuebot.proto.job_pb2.Group(name=group_name))
    ...
    def test_copyLogFileDir(self, clipboardMock):
        ...
        job1 = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(log_dir=logDir1))
        job2 = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(log_dir=logDir2))
...
class LayerActionsTests(unittest.TestCase):
    ...
    def test_view(self):
        ...
        layer = opencue.wrappers.layer.Layer(cuebot.proto.job_pb2.Layer(name=layer_name))
    ...
    def test_viewDepends(self, dependDialogMock):
        layer = opencue.wrappers.layer.Layer(
            cuebot.proto.job_pb2.Layer(name='arbitrary-name'))
    ...
    def test_setMinCores(self, getDoubleMock, setMinCoresMock):
        ...
        layer1 = opencue.wrappers.layer.Layer(
            cuebot.proto.job_pb2.Layer(min_cores=highest_current_core_count - 10))
        layer2 = opencue.wrappers.layer.Layer(
            cuebot.proto.job_pb2.Layer(min_cores=highest_current_core_count))
        getDoubleMock.return_value = (new_core_count, True)
    ...
    def test_setMinCoresCanceled(self, getDoubleMock, setMinCoresMock):
        layer1 = opencue.wrappers.layer.Layer(
            cuebot.proto.job_pb2.Layer(min_cores=0))
        layer2 = opencue.wrappers.layer.Layer(
            cuebot.proto.job_pb2.Layer(min_cores=0))
        getDoubleMock.return_value = (None, False)
    ...
    def test_setMinMemoryKbCanceled(self, getDoubleMock, setMinMemoryMock):
        layer1 = opencue.wrappers.layer.Layer(cuebot.proto.job_pb2.Layer(min_memory=0))
        layer2 = opencue.wrappers.layer.Layer(cuebot.proto.job_pb2.Layer(min_memory=0))
        getDoubleMock.return_value = (None, False)
    ...
    @mock.patch('cuegui.LocalBooking.LocalBookingDialog')
    def test_useLocalCores(self, localBookingDialogMock):
        layer = opencue.wrappers.layer.Layer(cuebot.proto.job_pb2.Layer())
    ...
    def test_setProperties(self, layerPropertiesDialogMock):
        layers = [opencue.wrappers.layer.Layer(cuebot.proto.job_pb2.Layer())]
    ...
    def test_retryDead(self, isPermissibleMock, yesNoMock):
        layer_name = 'arbitrary-name'
        layer = opencue.wrappers.layer.Layer(
            cuebot.proto.job_pb2.Layer(name=layer_name))
    ...
    def test_reorder(self, getTextMock, getItemMock, reorderFramesMock):
        ...
        reorderFramesMock.assert_called_with(
            layer, original_range, cuebot.proto.job_pb2.REVERSE)
...
class FrameActionsTests(unittest.TestCase):
    ...
    def test_viewHost(self, findHostMock):
        ...
        host = opencue.wrappers.host.Host(
            cuebot.proto.host_pb2.Host(id='arbitrary-id', name=host_name))
        frame = opencue.wrappers.frame.Frame(
            cuebot.proto.job_pb2.Frame(last_resource='{}/foo'.format(host_name)))
    ...
    def test_getWhatThisDependsOn(self):
        frame = opencue.wrappers.frame.Frame()
        depend = opencue.wrappers.depend.Depend(cuebot.proto.depend_pb2.Depend())
    ...
    def test_retry(self, isPermissibleMock, yesNoMock):
        ...
        frame = opencue.wrappers.frame.Frame(cuebot.proto.job_pb2.Frame(name=frame_name))
    ...
    def test_reorder(self, getItemMock, reorderFramesMock):
        ...
        frame_num = 28
        frame = opencue.wrappers.frame.Frame(
            cuebot.proto.job_pb2.Frame(layer_name=layer_name, number=frame_num))
        layer = opencue.wrappers.layer.Layer(
            cuebot.proto.job_pb2.Layer(name=layer_name))
        ...
        reorderFramesMock.assert_called_with(
            layer, str(frame_num), cuebot.proto.job_pb2.REVERSE)
    ...
    def test_eatandmarkdone(self, isPermissibleMock, yesNoMock, markdoneMock):
        ...
        frames = [
            opencue.wrappers.frame.Frame(
                cuebot.proto.job_pb2.Frame(name='frame1', layer_name=layer_name)),
            opencue.wrappers.frame.Frame(
                cuebot.proto.job_pb2.Frame(name='frame2', layer_name=layer_name))]
        layer = opencue.wrappers.layer.Layer(
            cuebot.proto.job_pb2.Layer(
                name=layer_name, layer_stats=cuebot.proto.job_pb2.LayerStats(
...
class GroupActionsTests(unittest.TestCase):
    ...
    def test_properties(self, modifyGroupDialogMock):
        group = opencue.wrappers.group.Group(group=cuebot.proto.job_pb2.Group())
...
class SubscriptionActionsTests(unittest.TestCase):
    ...
    def test_editSize(self, getDoubleMock, qMessageBoxMock):
        sub = opencue.wrappers.subscription.Subscription(
            cuebot.proto.subscription_pb2.Subscription(size=382))
    ...
    def test_editBurst(self, getDoubleMock):
        sub = opencue.wrappers.subscription.Subscription(
            cuebot.proto.subscription_pb2.Subscription(burst=922))
    ...
    def test_delete(self):
        sub = opencue.wrappers.subscription.Subscription(
            cuebot.proto.subscription_pb2.Subscription(name='arbitrary-name'))
...
class HostActionsTests(unittest.TestCase):
    ...
    def test_viewComments(self, commentListDialogMock):
        host = opencue.wrappers.host.Host(cuebot.proto.host_pb2.Host(id='arbitrary-id'))
    ...
    def test_viewProc(self):
        ...
        host = opencue.wrappers.host.Host(
            cuebot.proto.host_pb2.Host(id='arbitrary-id', name=hostName))
    ...
    def test_lock(self):
        host = opencue.wrappers.host.Host(
            cuebot.proto.host_pb2.Host(id='arbitrary-id'))
    ...
    def test_changeAllocation(self, getAllocationsMock, getItemMock):
        ...
        allocs = [
            opencue.wrappers.allocation.Allocation(
                cuebot.proto.facility_pb2.Allocation(name='alloc1')),
            opencue.wrappers.allocation.Allocation(
                cuebot.proto.facility_pb2.Allocation(name='alloc2')),
        ]
...
class ProcActionsTests(unittest.TestCase):
    ...
    def test_view(self, findJobMock):
        ...
        job = opencue.wrappers.job.Job(cuebot.proto.job_pb2.Job(name=jobName))
        proc = opencue.wrappers.proc.Proc(cuebot.proto.host_pb2.Proc(job_name=jobName))
    ...
    @mock.patch('cuegui.Utils.isPermissible', return_value=True)
    def test_kill(self, isPermissibleMock, yesNoMock):
        proc = opencue.wrappers.proc.Proc(cuebot.proto.host_pb2.Proc())
...
class DependenciesActionsTests(unittest.TestCase):
    ...
    def test_satisfy(self):
        dep = opencue.wrappers.depend.Depend(cuebot.proto.depend_pb2.Depend())
...
class FilterActionsTests(unittest.TestCase):
    ...
    def test_rename(self, getTextMock):
        filter_wrapper = opencue.wrappers.filter.Filter(cuebot.proto.filter_pb2.Filter())
...
class MatcherActionsTests(unittest.TestCase):
    ...
    @mock.patch('cuegui.Utils.questionBoxYesNo', new=mock.Mock(return_value=True))
    def test_delete(self):
        matcher = opencue.wrappers.filter.Matcher(cuebot.proto.filter_pb2.Matcher())
...
class ActionActionsTests(unittest.TestCase):
    ...
    @mock.patch('cuegui.Utils.questionBoxYesNo', new=mock.Mock(return_value=True))
    def test_delete(self):
        action = opencue.wrappers.filter.Action(cuebot.proto.filter_pb2.Action())
...
class TaskActionsTests(unittest.TestCase):
    ...
    @mock.patch('qtpy.QtWidgets.QInputDialog.getDouble')
    def test_setMinCores(self, getDoubleMock):
        task = opencue.wrappers.task.Task(cuebot.proto.task_pb2.Task(min_cores=10))
    ...
    def test_clearAdjustment(self):
        task = opencue.wrappers.task.Task(cuebot.proto.task_pb2.Task())
...
class LimitActionsTests(unittest.TestCase):
    ...
    @mock.patch('cuegui.Utils.questionBoxYesNo', new=mock.Mock(return_value=True))
    def test_delete(self):
        limit = opencue.wrappers.limit.Limit(cuebot.proto.limit_pb2.Limit())
    ...
    def test_editMaxValue(self, getDoubleMock):
        limit = opencue.wrappers.limit.Limit(cuebot.proto.limit_pb2.Limit(max_value=920))
