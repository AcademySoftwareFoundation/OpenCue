...
from cuegui.vendor import NodeGraphQt
...
class AbstractGraphWidget(QtWidgets.QWidget):
    ...
    def eventFilter(self, target, event):
        ...
        return super(AbstractGraphWidget, self).eventFilter(
            target, event
        )
    ...
    def layout_graph(self, horizontal=True):
        '''Layout the graph
        '''
        # TODO: look into using dot to perform graph layout.
        #       requires translating graph into Dot graph language
