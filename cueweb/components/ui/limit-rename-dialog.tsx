  ...
  return (
    <Dialog open={open} onOpenChange={submitting ? () => {} : setOpen}>
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          <DialogTitle>Rename a Limit</DialogTitle>
          <DialogDescription>Please enter the new Limit name:</DialogDescription>
        </DialogHeader>
