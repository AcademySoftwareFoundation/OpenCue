...
// Set a show's default maximum cores. Request: { show, max_cores }.
// RPC: /show.ShowInterface/SetDefaultMaxCores.
export async function POST(request: NextRequest) {
  const endpoint = "/show.ShowInterface/SetDefaultMaxCores";
