...
// Set a show's comment notification email. Request: { show, email }.
// RPC: /show.ShowInterface/SetCommentEmail.
export async function POST(request: NextRequest) {
  const endpoint = "/show.ShowInterface/SetCommentEmail";
  ...
  if (!jsonBody || typeof jsonBody !== 'object' || !jsonBody.show || typeof jsonBody.email !== 'string') {
