...
// Enable/disable dispatching for a show. Request: { show, enabled }.
// RPC: /show.ShowInterface/EnableDispatching.
export async function POST(request: NextRequest) {
  const endpoint = "/show.ShowInterface/EnableDispatching";
  ...
  if (!jsonBody || typeof jsonBody !== 'object' || !jsonBody.show || typeof jsonBody.enabled !== 'boolean') {
