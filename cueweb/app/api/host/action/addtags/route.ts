...
// Add one or more tags to a host. Request: { host, tags: string[] }.
// RPC: /host.HostInterface/AddTags (HostAddTagsRequest).
export async function POST(request: NextRequest) {
  const endpoint = "/host.HostInterface/AddTags";
  ...
  if (!jsonBody || typeof jsonBody !== 'object' || !jsonBody.host || !Array.isArray(jsonBody.tags)) {
