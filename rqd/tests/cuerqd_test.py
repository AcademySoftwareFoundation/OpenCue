...
@mock.patch('cuebot.proto.rqd_pb2_grpc.RunningFrameStub')
@mock.patch('cuebot.proto.rqd_pb2_grpc.RqdInterfaceStub')
...
class CueRqdTests(unittest.TestCase):
    ...
    def test_status(self, stubMock, frameStubMock):
        sys.argv = [SCRIPT_NAME, RQD_HOSTNAME, '-s']
        statusRequest = cuebot.proto.rqd_pb2.RqdStaticReportStatusRequest()
    ...
    def test_getRunningFrame(self, stubMock, frameStubMock):
        ...
        runFrameRequest = cuebot.proto.rqd_pb2.RqdStaticGetRunFrameRequest(frame_id=frameId)
    ...
    def test_nimbyOff(self, stubMock, frameStubMock):
        ...
        nimbyOffRequest = cuebot.proto.rqd_pb2.RqdStaticNimbyOffRequest()
    ...
    def test_nimbyOn(self, stubMock, frameStubMock):
        ...
        nimbyOnRequest = cuebot.proto.rqd_pb2.RqdStaticNimbyOnRequest()
    ...
    def test_lockAll(self, stubMock, frameStubMock):
        ...
        lockAllRequest = cuebot.proto.rqd_pb2.RqdStaticLockAllRequest()
    ...
    def test_unlockAll(self, stubMock, frameStubMock):
        ...
        unlockAllRequest = cuebot.proto.rqd_pb2.RqdStaticUnlockAllRequest()
    ...
    def test_lock(self, stubMock, frameStubMock):
        ...
        lockRequest = cuebot.proto.rqd_pb2.RqdStaticLockRequest(cores=numCoresToLock)
    ...
    def test_unlock(self, stubMock, frameStubMock):
        ...
        unlockRequest = cuebot.proto.rqd_pb2.RqdStaticUnlockRequest(cores=numCoresToUnlock)
    ...
    def test_shutdownRqdIdle(self, stubMock, frameStubMock):
        ...
        shutdownIdleRequest = cuebot.proto.rqd_pb2.RqdStaticShutdownIdleRequest()
    ...
    def test_shutdownRqdNow(self, stubMock, frameStubMock):
        ...
        shutdownNowRequest = cuebot.proto.rqd_pb2.RqdStaticShutdownNowRequest()
    ...
    def test_rebootIdle(self, stubMock, frameStubMock):
        ...
        rebootIdleRequest = cuebot.proto.rqd_pb2.RqdStaticRebootIdleRequest()
    ...
    def test_rebootNow(self, stubMock, frameStubMock):
        ...
        rebootNowRequest = cuebot.proto.rqd_pb2.RqdStaticRebootNowRequest()
    ...
    def test_launchFrame(self, stubMock, frameStubMock):
        ...
        runFrameRequest = cuebot.proto.rqd_pb2.RqdStaticLaunchFrameRequest(run_frame=runFrame)
    ...
    def test_killFrame(self, stubMock, frameStubMock):
        frameId = 'arbitrary-frame-id'
        runFrame = cuebot.proto.rqd_pb2.RunFrame(frame_id=frameId)
