...
class RqdReportStaticServer(object):
    ...
    def addServicers(self):
        addFunc = getattr(
            cuebot.proto.report_pb2_grpc, 'add_{0}_to_server'.format(self.servicerName))
...
class RqdReportInterfaceServicer(cuebot.proto.report_pb2_grpc.RqdReportInterfaceServicer):
