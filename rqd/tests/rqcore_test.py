...
class RqCoreTests(unittest.TestCase):
    ...
    def test_killAllFrame(self):
        ...
        frame1 = rqd.rqnetwork.RunningFrame(
            self.rqcore, cuebot.proto.rqd_pb2.RunFrame(frame_id=frame1Id)
        )
        frame1.frameAttendantThread = frameAttendantThread
        frame2 = rqd.rqnetwork.RunningFrame(
            self.rqcore, cuebot.proto.rqd_pb2.RunFrame(frame_id=frame2Id)
        )
        frame2.frameAttendantThread = frameAttendantThread
        frame3 = rqd.rqnetwork.RunningFrame(
            self.rqcore, cuebot.proto.rqd_pb2.RunFrame(frame_id=frame3Id)
        )
    ...
    def test_killAllFrameIgnoreNimby(self):
        ...
        frame2 = rqd.rqnetwork.RunningFrame(
            self.rqcore,
            cuebot.proto.rqd_pb2.RunFrame(frame_id=frame2Id, ignore_nimby=True),
        )
        frame2.frameAttendantThread = frameAttendantThread
        self.rqcore.storeFrame(frame1Id, frame1)
        self.rqcore.storeFrame(frame2Id, frame2)
    ...
    def test_releaseCores(self):
        ...
        self.rqcore.cores = cuebot.proto.report_pb2.CoreDetail(
            total_cores=50,
    ...
    def test_launchFrame(self, frameThreadMock):
        ...
        self.machineMock.return_value.state = cuebot.proto.host_pb2.UP
        self.nimbyMock.return_value.locked = False
        frame = cuebot.proto.rqd_pb2.RunFrame(uid=22, num_cores=10)
        rqd.rqconstants.OVERRIDE_NIMBY = None
    ...
    def test_launchFrameOnDownHost(self):
        self.machineMock.return_value.state = cuebot.proto.host_pb2.DOWN
        frame = cuebot.proto.rqd_pb2.RunFrame()
    ...
    def test_launchFrameOnNimbyHost(self, frameThreadMock):
        ...
        self.machineMock.return_value.state = cuebot.proto.host_pb2.UP
        frame = cuebot.proto.rqd_pb2.RunFrame(uid=22, num_cores=10)
        frameIgnoreNimby = cuebot.proto.rqd_pb2.RunFrame(
    ...
    def test_launchDuplicateFrame(self):
        ...
        self.rqcore.storeFrame(
            frameId, cuebot.proto.rqd_pb2.RunFrame(frame_id=frameId)
        )
        frameToLaunch = cuebot.proto.rqd_pb2.RunFrame(frame_id=frameId)
        rqd.rqconstants.OVERRIDE_NIMBY = None
    ...
    def test_launchFrameWithInvalidUid(self):
        self.machineMock.return_value.state = cuebot.proto.host_pb2.UP
        self.nimbyMock.return_value.locked = False
        frame = cuebot.proto.rqd_pb2.RunFrame(uid=0)
    ...
    def test_launchFrameWithInvalidCoreCount(self):
        self.machineMock.return_value.state = cuebot.proto.host_pb2.UP
        self.nimbyMock.return_value.locked = False
        frame = cuebot.proto.rqd_pb2.RunFrame(uid=22, num_cores=0)
    ...
    def test_getRunningFrame(self):
        frameId = "arbitrary-frame-id"
        frame = cuebot.proto.rqd_pb2.RunFrame(frame_id=frameId)
    ...
    def test_sendFrameCompleteReport(self):
        ...
        children = cuebot.proto.report_pb2.ChildrenProcStats()
        returnCode = 0
        ...
        renderHost = cuebot.proto.report_pb2.RenderHost(
        ...
        self.rqcore.network.reportRunningFrameCompletion.assert_called_once_with(
            cuebot.proto.report_pb2.FrameCompleteReport(
                    host=renderHost,
                    frame=cuebot.proto.report_pb2.RunningFrameInfo(
                        job_name=jobName,
                        frame_id=frameId,
                        frame_name=frameName,
                        children=children,
...
class FrameAttendantThreadTests(pyfakefs.fake_filesystem_unittest.TestCase):
    ...
    def test_runDocker(self, getTempDirMock, permsUser, timeMock, popenMock):
        ...
        renderHost = cuebot.proto.report_pb2.RenderHost(name='arbitrary-host-name')
        logFile = os.path.join(logDir, '%s.%s.rqlog' % (jobName, frameName))
