...
class RqdReportStaticServer(object):
    ...
    def addServicers(self):
        addFunc = getattr(
            opencue.compiled_proto.report_pb2_grpc, 'add_{0}_to_server'.format(self.servicerName))
...
class RqdReportInterfaceServicer(opencue.compiled_proto.report_pb2_grpc.RqdReportInterfaceServicer):
