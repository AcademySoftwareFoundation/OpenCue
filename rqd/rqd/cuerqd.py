...
import cuebot.proto.rqd_pb2_grpc
...
class RqdHost(object):
    ...
    def restartRqdIdle(self):
        ...
        self.stub.RestartRqdIdle(cuebot.proto.rqd_pb2.RqdStaticRestartIdleRequest())

    def rebootIdle(self):
        """Reboots the host when idle."""
        print(self.rqdHost, "Sending rebootIdle command")
        self.stub.RebootIdle(cuebot.proto.rqd_pb2.RqdStaticRebootIdleRequest())

    def rebootNow(self):
        """Reboots the host now."""
        print(self.rqdHost, "Sending rebootNow command")
        self.stub.RebootNow(cuebot.proto.rqd_pb2.RqdStaticRebootNowRequest())

    def launchFrame(self, frame):
        """Launches a frame on the host."""
        self.stub.LaunchFrame(
            cuebot.proto.rqd_pb2.RqdStaticLaunchFrameRequest(run_frame=frame))
...
def main():
    ...
    if args.test_edu_frame:
        ...
        frameNum = "0001"
        runFrame = cuebot.proto.rqd_pb2.RunFrame()
