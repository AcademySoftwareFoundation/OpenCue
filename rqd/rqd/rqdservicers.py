...
class RqdInterfaceServicer(cuebot.proto.rqd_pb2_grpc.RqdInterfaceServicer):
    ...
    def LaunchFrame(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticLaunchFrameResponse()

    def ReportStatus(self, request, context):
        """RPC call that returns reportStatus"""
        log.info("Request received: reportStatus")
        return cuebot.proto.rqd_pb2.RqdStaticReportStatusResponse(
    ...
    def GetRunningFrameStatus(self, request, context):
        ...
        if frame:
            return cuebot.proto.rqd_pb2.RqdStaticGetRunningFrameStatusResponse(
    ...
    def KillRunningFrame(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticKillRunningFrameResponse()
    ...
    def ShutdownRqdNow(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticShutdownNowResponse()
    ...
    def ShutdownRqdIdle(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticShutdownIdleResponse()
    ...
    def RestartRqdNow(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticRestartNowResponse()
    ...
    def RestartRqdIdle(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticRestartIdleResponse()
    ...
    def RebootNow(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticRebootNowResponse()
    ...
    def Lock(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticLockResponse()

    def LockAll(self, request, context):
        """RPC call that locks all cores"""
        log.info("Request received: lockAll")
        self.rqCore.lockAll()
        return cuebot.proto.rqd_pb2.RqdStaticLockAllResponse()
    ...
    def Unlock(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticUnlockResponse()
    ...
    def UnlockAll(self, request, context):
        ...
        return cuebot.proto.rqd_pb2.RqdStaticUnlockAllResponse()
