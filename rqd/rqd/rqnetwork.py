...
import cuebot.proto.report_pb2_grpc
...
class RunningFrame(object):
    ...
    def runningFrameInfo(self):
        ...
        runningFrameInfo = cuebot.proto.report_pb2.RunningFrameInfo(
    ...
    def _serializeChildrenProcs(self):
        ...
        :rtype: cuebot.proto.report_pb2.ChildrenProcStats
        """
        childrenProc = cuebot.proto.report_pb2.ChildrenProcStats()
        for proc, values in self.childrenProcs.items():
            procStats = cuebot.proto.report_pb2.ProcStats()
            procStatFile = cuebot.proto.report_pb2.Stat()
            procStatmFile = cuebot.proto.report_pb2.Statm()
...
class GrpcServer(object):
    ...
    def addServicers(self):
        ...
        for servicer in self.servicers:
            addFunc = getattr(cuebot.proto.rqd_pb2_grpc, 'add_{0}_to_server'.format(servicer))
...
class Network(object):
    ...
    def __getReportStub(self):
        self.__getChannel()
        return cuebot.proto.report_pb2_grpc.RqdReportInterfaceStub(self.channel)

    def reportRqdStartup(self, report):
        """Wraps the ability to send a startup report to rqd via grpc"""
        stub = self.__getReportStub()
        request = cuebot.proto.report_pb2.RqdReportRqdStartupRequest(boot_report=report)
    ...
    def reportStatus(self, report):
        ...
        stub = self.__getReportStub()
        request = cuebot.proto.report_pb2.RqdReportStatusRequest(host_report=report)
    ...
    def reportRunningFrameCompletion(self, report):
        ...
        stub = self.__getReportStub()
        request = cuebot.proto.report_pb2.RqdReportRunningFrameCompletionRequest(
