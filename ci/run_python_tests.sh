...
python -m pip uninstall --yes opencue_pyoutline opencue_proto opencue_pycue opencue_cueadmin opencue_cueman opencue_cuesubmit opencue_rqd opencue_cuecmd opencue_cuenimby
...
for package in pyoutline pycue cueadmin cueman cuesubmit rqd cuecmd cuenimby
do
