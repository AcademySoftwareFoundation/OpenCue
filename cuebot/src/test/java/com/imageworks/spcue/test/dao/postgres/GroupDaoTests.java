...
public class GroupDaoTests extends AbstractTransactionalJUnit4SpringContextTests {
  ...
  public void testUpdateGroupParent() {
    ...
    assertEquals(Integer.valueOf(1), jdbcTemplate.queryForObject(
        "SELECT int_level FROM folder_level WHERE pk_folder=?", Integer.class, subgroup.getId()));
  ...
  public void testUpdateDefaultJobMaxCores() {
    ...
    assertEquals(Integer.valueOf(-1),
        jdbcTemplate.queryForObject("SELECT int_job_max_cores FROM folder WHERE pk_folder=?",
  ...
  public void testUpdateDefaultJobMinCores() {
    GroupDetail group = createGroup();
    assertEquals(Integer.valueOf(-1),
        jdbcTemplate.queryForObject("SELECT int_job_min_cores FROM folder WHERE pk_folder=?",
            Integer.class, group.getGroupId()));
  ...
  public void testUpdateMinCores() {
    ...
    assertEquals(Integer.valueOf(0),
        jdbcTemplate.queryForObject("SELECT int_min_cores FROM folder_resource WHERE pk_folder=?",
            Integer.class, group.getGroupId()));
  ...
  public void testUpdateMaxCores() {
    GroupDetail group = createGroup();
    assertEquals(Integer.valueOf(-1),
        jdbcTemplate.queryForObject("SELECT int_max_cores FROM folder_resource WHERE pk_folder=?",
            Integer.class, group.getGroupId()));
  ...
  public void testUpdateMinGpus() {
    GroupDetail group = createGroup();
    assertEquals(Integer.valueOf(0),
        jdbcTemplate.queryForObject("SELECT int_min_gpus FROM folder_resource WHERE pk_folder=?",
            Integer.class, group.getGroupId()));
  ...
  public void testUpdateMaxGpus() {
    GroupDetail group = createGroup();
    assertEquals(Integer.valueOf(-1),
        jdbcTemplate.queryForObject("SELECT int_max_gpus FROM folder_resource WHERE pk_folder=?",
            Integer.class, group.getGroupId()));
  ...
  public void testIsOverMinCores() {
    ...
    jdbcTemplate.update(
        "UPDATE folder_resource SET int_cores = int_min_cores + 1 WHERE pk_folder=?", groupid);
