...
public class CueUtilTester extends TestCase {
  ...
  public void testFindChunk() {
    ...
    List<Integer> dependOnFrameSet = CueUtil.normalizeFrameRange("101-160x10", 1);
    List<Integer> dependErFrameSet = CueUtil.normalizeFrameRange("101-160", 1);

    Integer[] results = new Integer[] {101, 101, 101, 101, 101, 101, 101, 101, 101, 101, 111, 111,
        111, 111, 111, 111, 111, 111, 111, 111, 121, 121, 121, 121, 121, 121, 121, 121, 121, 121,
        131, 131, 131, 131, 131, 131, 131, 131, 131, 131, 141, 141, 141, 141, 141, 141, 141, 141,
        141, 141, 151, 151, 151, 151, 151, 151, 151, 151, 151, 151};

    for (int dependErFrameSetIdx = 0; dependErFrameSetIdx < dependErFrameSet
        .size(); dependErFrameSetIdx = dependErFrameSetIdx + 1) {

      int result = CueUtil.findChunk(dependOnFrameSet, dependErFrameSet.get(dependErFrameSetIdx));
  ...
  public void testFindChunkStaggered() {
    ...
    List<Integer> dependOnFrameSet = CueUtil.normalizeFrameRange("101-110:2", 1);
    List<Integer> dependErFrameSet = CueUtil.normalizeFrameRange("101-110", 1);

    Integer[] results = new Integer[] {101, 102, 103, 104, 105, 106, 107, 108, 109, 110};
  ...
  /**
   * Removes all duplicates from the frame range, applies the chunk size, and maintains dispatch
   * order.
   */
