...
public class ManageFrameTests extends AbstractTransactionalJUnit4SpringContextTests  {
    ...
    public void testFrameStateOverride() {
        ...
        Frame jobFrame = Frame.newBuilder()
                .setId(frame.getFrameId())
        ...
        FrameStateDisplayOverride overrideUpdated = createFrameStateDisplayOverride(FrameState.SUCCEEDED,
                "DONE", 200, 200, 123);
        FrameStateDisplayOverrideRequest reqUpdated = FrameStateDisplayOverrideRequest.newBuilder()
                .setFrame(jobFrame)
                .setOverride(overrideUpdated)
                .build();
        ...
        //add a new override
        FrameStateDisplayOverride overrideNew = createFrameStateDisplayOverride(FrameState.EATEN,
                "NOMNOM", 120, 50, 123);
        FrameStateDisplayOverrideRequest reqNew = FrameStateDisplayOverrideRequest.newBuilder()
                .setFrame(jobFrame)
                .setOverride(overrideNew)
                .build();
