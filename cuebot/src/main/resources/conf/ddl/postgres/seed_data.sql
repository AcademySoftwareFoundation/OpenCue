...
-- int_timeout is in milliseconds (lockTask compares a millisecond delta): 300000 = 5 minutes.
Insert into TASK_LOCK (PK_TASK_LOCK,STR_NAME,INT_LOCK,INT_TIMEOUT) values ('00000000-0000-0000-0000-000000000008','LOCK_ORPHANED_FRAME_CHECK',0,300000);
