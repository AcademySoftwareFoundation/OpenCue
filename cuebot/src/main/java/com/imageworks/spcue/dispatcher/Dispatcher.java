...
public interface Dispatcher {
    ...
    // Maximum core points per frame when the in-process Maestro is enabled.
    // Maestro places whole-host-sized layers (it tracks contiguous idle
    ...
    public static final int CORE_POINTS_RESERVED_MAX_MAESTRO = 6400;
