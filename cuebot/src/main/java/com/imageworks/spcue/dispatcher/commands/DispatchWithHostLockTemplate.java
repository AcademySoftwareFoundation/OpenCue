 ...
 * @category command
 */
public abstract class DispatchWithHostLockTemplate{

    public abstract void lockCommand();
    public abstract void wrapDispatchCommand();
    public abstract void unlockCommand();
    ...
    public void execute() {
        try {
            ...
            CueExceptionUtil.logStackTrace(
                "Failed to lock host " + this.getClass().toString() + " caught error ",
                rrfe);
            ...
            try {
                ...
                CueExceptionUtil.logStackTrace(
                    "Failed to unlock host " + this.getClass().toString() + " caught error ",
                    rrfe);
            }
        }
    }
