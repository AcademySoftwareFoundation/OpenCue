...
public class SqlUtil {
  ...
  /**
   * returns a 32 character UUID string that will be identical everytime its generated based on the
   * name passed in.
   *
   * @param name String
   * @return String
  ...
  /**
   * returns a 36 character UUID string that will be identical everytime its generated based on the
   * name passed in.
   *
   * @param name String
   * @return String
