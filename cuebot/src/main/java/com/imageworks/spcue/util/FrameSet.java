...
public class FrameSet {
   ...
   *
   * See FrameRange for the supported syntax. A FrameSet follows the same syntax, with the addition
   * that it may be a comma-separated list of different FrameRanges.
   */
