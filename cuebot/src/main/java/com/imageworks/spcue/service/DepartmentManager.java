...
public interface DepartmentManager {
  ...
  /**
   * Sets the minimum core value for the specified task. If the task is managed then the cores will
   * be adjusted, leaving the original min cores value in tact. If the task is not managed then the
   * min cores value is altered directly.
   *
   * @param t
   * @param value
   */
