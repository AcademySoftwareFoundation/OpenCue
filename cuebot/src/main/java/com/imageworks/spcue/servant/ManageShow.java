...
import com.imageworks.spcue.grpc.show.ShowSetDefaultMaxGpusRequest;
...
public class ManageShow extends ShowInterfaceGrpc.ShowInterfaceImplBase {
  ...
  public void createShow(ShowCreateShowRequest request,
    ...
    try {
      ...
      responseObserver
          .onError(Status.INTERNAL.withDescription("Show could not be created." + e.getMessage())
  ...
  public void getActiveShows(ShowGetActiveShowsRequest request,
    ...
    responseObserver.onNext(
        ShowGetActiveShowsResponse.newBuilder().setShows(whiteboard.getActiveShows()).build());
    responseObserver.onCompleted();
  }
  ...
  public void getDepartment(ShowGetDepartmentRequest request,
    ...
    ShowGetDepartmentResponse response = ShowGetDepartmentResponse.newBuilder()
        .setDepartment(
            whiteboard.getDepartment(getShowEntity(request.getShow()), request.getDepartment()))
        .build();
    responseObserver.onNext(response);
    responseObserver.onCompleted();
  }
  ...
  public void getDeeds(ShowGetDeedsRequest request,
    ...
    ShowEntity show = getShowEntity(request.getShow());
    responseObserver
        .onNext(ShowGetDeedsResponse.newBuilder().setDeeds(whiteboard.getDeeds(show)).build());
    responseObserver.onCompleted();
  }
  ...
  public void createServiceOverride(ShowCreateServiceOverrideRequest request,
    ...
    service.maxGpus = requestService.getMaxGpus();
    ...
    responseObserver.onNext(
        ShowCreateServiceOverrideResponse.newBuilder().setServiceOverride(serviceOverride).build());
    responseObserver.onCompleted();
  }
  ...
  public void getServiceOverride(ShowGetServiceOverrideRequest request,
    ...
    responseObserver.onNext(
        ShowGetServiceOverrideResponse.newBuilder().setServiceOverride(serviceOverride).build());
    responseObserver.onCompleted();
  }
