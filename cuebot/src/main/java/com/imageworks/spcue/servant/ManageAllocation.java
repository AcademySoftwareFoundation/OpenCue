...
public class ManageAllocation extends AllocationInterfaceGrpc.AllocationInterfaceImplBase {
  ...
  public void getAll(AllocGetAllRequest request,
    ...
    responseObserver.onNext(
        AllocGetAllResponse.newBuilder().setAllocations(whiteboard.getAllocations()).build());
    responseObserver.onCompleted();
  }
  ...
  public void getHosts(AllocGetHostsRequest request,
    ...
    responseObserver.onNext(AllocGetHostsResponse.newBuilder()
        .setHosts(whiteboard
            .getHosts(hostSearchFactory.create(toAllocationEntity(request.getAllocation()))))
        .build());
    responseObserver.onCompleted();
  }
