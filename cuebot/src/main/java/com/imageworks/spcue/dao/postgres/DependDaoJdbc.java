...
public class DependDaoJdbc extends JdbcDaoSupport implements DependDao {
  ...
  public static final RowMapper<LightweightDependency> DEPEND_MAPPER =
      new RowMapper<LightweightDependency>() {
  ...
  public void insertDepend(JobOnJob d) {
    ...
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErJob().getJobId(), null,
        null, d.getDependOnJob().getJobId(), null, null, DependType.JOB_ON_JOB.toString(),
        d.isAnyFrame(), d.getTarget().toString(), d.isActive(), d.getSignature(), d.isComposite());
  }
  ...
  public void insertDepend(JobOnLayer d) {
    d.setId(SqlUtil.genKeyRandom());
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErJob().getJobId(), null,
        null, d.getDependOnLayer().getJobId(), d.getDependOnLayer().getLayerId(), null,
        DependType.JOB_ON_LAYER.toString(), d.isAnyFrame(), d.getTarget().toString(), d.isActive(),
        d.getSignature(), d.isComposite());
  }
  ...
  public void insertDepend(JobOnFrame d) {
    d.setId(SqlUtil.genKeyRandom());
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErJob().getJobId(), null,
        null, d.getDependOnFrame().getJobId(), d.getDependOnFrame().getLayerId(),
        d.getDependOnFrame().getFrameId(), DependType.JOB_ON_FRAME.toString(), d.isAnyFrame(),
        d.getTarget().toString(), d.isActive(), d.getSignature(), d.isComposite());
  }

  @Override
  public void insertDepend(LayerOnJob d) {
    d.setId(SqlUtil.genKeyRandom());
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErLayer().getJobId(),
        d.getDependErLayer().getLayerId(), null, d.getDependOnJob().getJobId(), null, null,
        DependType.LAYER_ON_JOB.toString(), d.isAnyFrame(), d.getTarget().toString(), d.isActive(),
        d.getSignature(), d.isComposite());
  }
  ...
  public void insertDepend(LayerOnLayer d) {
    d.setId(SqlUtil.genKeyRandom());
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErLayer().getJobId(),
        d.getDependErLayer().getLayerId(), null, d.getDependOnLayer().getJobId(),
        d.getDependOnLayer().getLayerId(), null, DependType.LAYER_ON_LAYER.toString(),
        d.isAnyFrame(), d.getTarget().toString(), d.isActive(), d.getSignature(), d.isComposite());
  }
  ...
  public void insertDepend(LayerOnFrame d) {
    d.setId(SqlUtil.genKeyRandom());
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErLayer().getJobId(),
        d.getDependErLayer().getLayerId(), null, d.getDependOnFrame().getJobId(),
        d.getDependOnFrame().getLayerId(), d.getDependOnFrame().getFrameId(),
        DependType.LAYER_ON_FRAME.toString(), d.isAnyFrame(), d.getTarget().toString(),
        d.isActive(), d.getSignature(), d.isComposite());
  }

  @Override
  public void insertDepend(FrameOnJob d) {
    d.setId(SqlUtil.genKeyRandom());
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErFrame().getJobId(),
        d.getDependErFrame().getLayerId(), d.getDependErFrame().getFrameId(),
        d.getDependOnJob().getJobId(), null, null, DependType.FRAME_ON_JOB.toString(),
        d.isAnyFrame(), d.getTarget().toString(), d.isActive(), d.getSignature(), d.isComposite());
  }
  ...
  public void insertDepend(FrameOnLayer d) {
    ...
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErFrame().getJobId(),
        d.getDependErFrame().getLayerId(), d.getDependErFrame().getFrameId(),
        d.getDependOnLayer().getJobId(), d.getDependOnLayer().getLayerId(), null,
        DependType.FRAME_ON_LAYER.toString(), d.isAnyFrame(), d.getTarget().toString(),
        d.isActive(), d.getSignature(), d.isComposite());
  }
  ...
  public void insertDepend(PreviousFrame d) {
    ...
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErLayer().getJobId(),
        d.getDependErLayer().getLayerId(), null, d.getDependOnLayer().getJobId(),
        d.getDependOnLayer().getLayerId(), null, DependType.PREVIOUS_FRAME.toString(),
        d.isAnyFrame(), d.getTarget().toString(), d.isActive(), d.getSignature(), d.isComposite());
  }
  ...
  public void insertDepend(FrameOnFrame d) {
    ...
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), parentId, d.getDependErFrame().getJobId(),
        d.getDependErFrame().getLayerId(), d.getDependErFrame().getFrameId(),
        d.getDependOnFrame().getJobId(), d.getDependOnFrame().getLayerId(),
        d.getDependOnFrame().getFrameId(), DependType.FRAME_ON_FRAME.toString(), d.isAnyFrame(),
        d.getTarget().toString(), d.isActive(), d.getSignature(), d.isComposite());
  }
  ...
  public void insertDepend(FrameByFrame d) {
    ...
    getJdbcTemplate().update(INSERT_DEPEND, d.getId(), null, d.getDependErLayer().getJobId(),
        d.getDependErLayer().getLayerId(), null, d.getDependOnLayer().getJobId(),
        d.getDependOnLayer().getLayerId(), null, DependType.FRAME_BY_FRAME.toString(),
        d.isAnyFrame(), d.getTarget().toString(), d.isActive(), d.getSignature(), d.isComposite());
  }

  private static final String UPDATE_FRAME_STATE =
      "UPDATE " + "frame " + "SET " + "str_state='DEPEND' " + "WHERE " + "int_depend_count != 0 "
          + "AND " + "frame.str_state NOT IN ('SUCCEEDED','EATEN','RUNNING','DEPEND') " + "AND "
          + "frame.pk_frame = ?";
  ...
  public void incrementDependCount(FrameInterface f) {
    int result = getJdbcTemplate().update(UPDATE_DEPEND_COUNT, f.getFrameId());
    if (result == 0) {
      throw new DependException("updating the depend count for " + " the frame " + f.getName()
          + " in job " + f.getJobId() + "failed.");
    }
  }
  ...
  public LightweightDependency getDependBySignature(String s) {
    return getJdbcTemplate().queryForObject(GET_LIGHTWEIGHT_DEPEND_BY_SIGNATURE, DEPEND_MAPPER, s);
  }
  ...
  private static final String GET_WHAT_DEPENDS_ON_JOB = "SELECT " + "depend.pk_depend,"
      ...
      + "depend.pk_layer_depend_er," + "depend.pk_layer_depend_on," + "depend.pk_job_depend_er,"
      + "depend.pk_job_depend_on " + "FROM " + "depend " + "WHERE " + "pk_job_depend_on=? " + "AND "
      + "b_active = true " + "AND " + "str_type IN (?,?,?)";

  @Override
  public List<LightweightDependency> getWhatDependsOn(JobInterface job) {
    return getJdbcTemplate().query(GET_WHAT_DEPENDS_ON_JOB, DEPEND_MAPPER, job.getJobId(),
        DependType.JOB_ON_JOB.toString(), DependType.LAYER_ON_JOB.toString(),
        DependType.FRAME_ON_JOB.toString());
  }

  private static final String GET_WHAT_DEPENDS_ON_JOB_WITH_TARGET = "SELECT " + "depend.pk_depend,"
      + "depend.str_type," + "depend.str_target," + "depend.b_any," + "depend.pk_parent,"
      + "depend.b_active," + "depend.pk_frame_depend_er," + "depend.pk_frame_depend_on,"
      + "depend.pk_layer_depend_er," + "depend.pk_layer_depend_on," + "depend.pk_job_depend_er,"
      + "depend.pk_job_depend_on " + "FROM " + "depend " + "WHERE " + "pk_job_depend_on=? " + "AND "
      + "b_active = true " + "AND " + "str_target = ? " + "AND " + "str_type IN (?,?,?)";
  ...
  public List<LightweightDependency> getWhatDependsOn(JobInterface job, DependTarget target) {
    if (target.equals(DependTarget.ANY_TARGET)) {
      ...
      return getJdbcTemplate().query(GET_WHAT_DEPENDS_ON_JOB_WITH_TARGET, DEPEND_MAPPER,
          job.getJobId(), target.toString(), DependType.JOB_ON_JOB.toString(),
          DependType.LAYER_ON_JOB.toString(), DependType.FRAME_ON_JOB.toString());
    }
  }
  ...
  private static final String GET_WHAT_DEPENDS_ON_LAYER = "SELECT " + "depend.pk_depend,"
      ...
      + "depend.pk_layer_depend_er," + "depend.pk_layer_depend_on," + "depend.pk_job_depend_er,"
      + "depend.pk_job_depend_on " + "FROM " + "depend " + "WHERE " + "pk_job_depend_on=? " + "AND "
      + "pk_layer_depend_on=? " + "AND " + "str_type IN (?,?,?) " + "AND " + "b_active = ?";

  @Override
  public List<LightweightDependency> getWhatDependsOn(LayerInterface layer) {
    return getJdbcTemplate().query(GET_WHAT_DEPENDS_ON_LAYER, DEPEND_MAPPER, layer.getJobId(),
        layer.getLayerId(), DependType.JOB_ON_LAYER.toString(),
        DependType.LAYER_ON_LAYER.toString(), DependType.FRAME_ON_LAYER.toString(), true);
  }
  ...
  private static final String GET_WHAT_DEPENDS_ON_FRAME =
      "SELECT " + "depend.pk_depend," + "depend.str_type," + "depend.str_target," + "depend.b_any,"
          ...
          + "FROM " + "depend " + "WHERE " + "b_active = ? " + "AND " + "pk_job_depend_on = ? "
          + "AND " + "(pk_frame_depend_on = ? " + "AND " + "str_type IN (?,?,?)) " + "OR "
  ...
  public List<LightweightDependency> getWhatDependsOn(FrameInterface frame, boolean active) {
    return getJdbcTemplate().query(GET_WHAT_DEPENDS_ON_FRAME, DEPEND_MAPPER, active,
        frame.getJobId(), frame.getFrameId(), DependType.FRAME_ON_FRAME.toString(),
        DependType.LAYER_ON_FRAME.toString(), DependType.JOB_ON_FRAME.toString(),
  ...
  private static final String SET_INACTIVE = "UPDATE " + "depend " + "SET " + "b_active=false,"
      + "ts_satisfied=current_timestamp," + "str_signature=pk_depend " + "WHERE " + "pk_depend = ? "
      + "AND " + "b_active = true " + "AND " + "b_composite = false";
  ...
  public boolean setActive(LightweightDependency depend) {
    ...
    depend.active = getJdbcTemplate().update(SET_ACTIVE, depend.getId()) == 1;
    return depend.active;
  }
  ...
  private static final String GET_CHILD_DEPENDS = "SELECT " + "depend.pk_depend,"
      ...
      + "depend.b_active," + "depend.pk_frame_depend_er," + "depend.pk_frame_depend_on,"
      + "depend.pk_layer_depend_er," + "depend.pk_layer_depend_on," + "depend.pk_job_depend_er,"
      + "depend.pk_job_depend_on " + "FROM " + "depend " + "WHERE " + "depend.pk_job_depend_er = ? "
      + "AND " + "depend.pk_job_depend_on = ? " + "AND " + "depend.pk_parent = ? " + "AND "
      + "depend.b_active = true ";

  @Override
  public List<LightweightDependency> getChildDepends(LightweightDependency depend) {
    return getJdbcTemplate().query(GET_CHILD_DEPENDS, DEPEND_MAPPER, depend.dependErJobId,
  ...
  private static final String GET_WHAT_THIS_JOB_DEPENDS_ON = "SELECT " + "depend.pk_depend,"
      ...
      + "depend.pk_layer_depend_er," + "depend.pk_layer_depend_on," + "depend.pk_job_depend_er,"
      + "depend.pk_job_depend_on " + "FROM " + "depend " + "WHERE " + "depend.pk_job_depend_er = ? "
      + "AND " + "depend.b_active = true " + "AND " + "depend.pk_parent IS NULL ";
  ...
  private static final String GET_WHAT_THIS_LAYER_DEPENDS_ON = "SELECT " + "depend.pk_depend,"
      ...
      + "depend.b_active," + "depend.pk_frame_depend_er," + "depend.pk_frame_depend_on,"
      + "depend.pk_layer_depend_er," + "depend.pk_layer_depend_on," + "depend.pk_job_depend_er,"
      + "depend.pk_job_depend_on " + "FROM " + "depend " + "WHERE "
      + "depend.pk_layer_depend_er = ? " + "AND " + "depend.b_active = true " + "AND "
      + "depend.pk_parent IS NULL " + "AND " + "depend.str_type IN (?,?,?,?) ";
  ...
  public List<LightweightDependency> getWhatThisDependsOn(LayerInterface layer,
    ...
    if (!target.equals(DependTarget.ANY_TARGET)) {
      ...
      return getJdbcTemplate().query(query, DEPEND_MAPPER, layer.getLayerId(),
          DependType.LAYER_ON_JOB.toString(), DependType.LAYER_ON_LAYER.toString(),
          DependType.LAYER_ON_FRAME.toString(), DependType.FRAME_BY_FRAME.toString(),
          target.toString());
    } else {
  ...
  private static final String GET_WHAT_THIS_FRAME_DEPENDS_ON =
      "SELECT " + "depend.pk_depend," + "depend.str_type," + "depend.str_target," + "depend.b_any,"
          ...
          + "depend.pk_frame_depend_on," + "depend.pk_layer_depend_er,"
          + "depend.pk_layer_depend_on," + "depend.pk_job_depend_er," + "depend.pk_job_depend_on "
          + "FROM " + "depend " + "WHERE " + "depend.pk_frame_depend_er = ? " + "AND "
          + "depend.b_active = true " + "AND " + "depend.str_type IN (?,?,?) ";
  ...
  public List<LightweightDependency> getWhatThisDependsOn(FrameInterface frame,
    ...
    if (!target.equals(DependTarget.ANY_TARGET)) {
      ...
      return getJdbcTemplate().query(query, DEPEND_MAPPER, frame.getFrameId(),
          DependType.FRAME_ON_JOB.toString(), DependType.FRAME_ON_LAYER.toString(),
          DependType.FRAME_ON_FRAME.toString(), target.toString());
    } else {
