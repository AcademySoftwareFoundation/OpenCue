...
public class EmailSupport {
    ...
    private Properties cue3Properties;
    ...
    public EmailSupport() {
        ...
        /*
         * The cue3 configuration file which we need to find the email template.
         */
        cue3Properties = getCue3Properties();

        Map<String, byte[]> map = new HashMap<String, byte[]>();

        loadImage(map, "bar.png");
        loadImage(map, "cue3.png");
    ...
    public void reportLaunchError(JobSpec spec, Throwable t) {
        ...
        msg.setSubject("Failed to launch Cue3 job.");
    ...
    public void reportJobComment(JobInterface job, CommentDetail c, String[] emails) {
        ...
        SimpleMailMessage msg = new SimpleMailMessage();
        msg.setTo(emails);
        msg.setFrom("cue3-noreply@imageworks.com");
    ...
    public Properties getCue3Properties() {
        ...
        try {
            ...
            props.setProperty("file.resource.loader.path", "/opt/cue3/webapps/spcue");
        }
        return props;
    }
    ...
    public void sendShutdownEmail(JobInterface job) {
        ...
        try {
            ...
            String subject = "Cue3 Job " + d.getName();
