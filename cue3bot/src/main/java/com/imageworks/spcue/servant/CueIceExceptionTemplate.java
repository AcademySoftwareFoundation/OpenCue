...
public abstract class CueIceExceptionTemplate<T> {

    public CueIceExceptionTemplate() { }

    public abstract T throwOnlyIceExceptions() throws CueIceException;

    public T execute() throws CueIceException {
        try {

            IceServer.dataRequests.incrementAndGet();
            return this.throwOnlyIceExceptions();

        } catch (CueIceException e) {
            throw e;
            ...
            throw new CueIceException("Error executing Ice method " +
