...
public class ManageServiceOverrideI extends _ServiceInterfaceDisp
    ...
    private ServiceOverride service;

    public ManageServiceOverrideI(Ice.Identity i) {
        id = i.name;
    }
    ...
    public void update(final ServiceData update, Current arg1) throws SpiIceException {
        new SpiIceExceptionMinimalTemplate() {
            public void throwOnlyIceExceptions() {
                ServiceOverride updated = new ServiceOverride();
                updated.id = service.id;
                updated.showId = service.showId;
    ...
    public void afterPropertiesSet() throws Exception {
        service = serviceManager.getServiceOverride(id);
    }
