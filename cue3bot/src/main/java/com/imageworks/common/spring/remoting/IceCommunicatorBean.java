...
public class IceCommunicatorBean {

    private Ice.Communicator communicator;

    public IceCommunicatorBean(Properties props) {

        Ice.InitializationData init_data = new Ice.InitializationData();
        init_data.properties = Ice.Util.createProperties() ;

        for(Entry set: props.entrySet()) {
