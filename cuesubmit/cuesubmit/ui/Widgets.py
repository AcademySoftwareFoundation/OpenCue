...
class CueLabelSlider(QtWidgets.QWidget):
    """Container widget that holds a label and an int slider.
    ...
    def __init__(self, label=None, parent=None, default_value=0, min_value=0, max_value=999, float_precision=None):
        ...
        self.slider.setValue(default_value*self.float_mult)
